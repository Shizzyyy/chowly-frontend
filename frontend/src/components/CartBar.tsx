import { ShoppingBag, Clock, X, Plus, Minus, Trash2 } from 'lucide-react';
...
export default function CartBar({ onOrderPlaced }: CartBarProps) {
  const {
    cart,
    cartCount,
    cartTotal,
  ...
  return (
    <>
      ...
      >
        <div className="max-h-[60vh] overflow-y-auto p-5 scrollbar-hide">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <p className="text-xs text-ink-300">
                ...
                {formatPrepTime(cartPrepTime)} wait
              </p>
